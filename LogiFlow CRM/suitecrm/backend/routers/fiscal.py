...
class VeiculoCTe(BaseModel):
    ...
    uf: str
    tipo: Optional[str] = "02"  # 02=Caminhão
...
class EmitirCTeRequest(BaseModel):
    ...
    modal: Optional[str] = "01"  # 01=Rodoviário
...
class EmitirMDFeRequest(BaseModel):
    numero: Optional[int] = None
    serie: Optional[str] = "1"
    modal: Optional[str] = "1"  # 1=Rodoviário
...
async def emitir_cte(
    ...
    - Atualiza pedido no SuiteCRM com chave e número
    """
    try:
        ...
        # TODO: Atualizar pedido no SuiteCRM com os dados do CT-e
        # suitecrm_client.update_pedido(request.pedido_id, {
        #     "cte_numero": result["numero"],
        #     "cte_chave": result["chave"],
        #     "cte_status": "emitido",
        #     "cte_data_emissao": result["data_emissao"]
        # })
...
async def cancelar_cte(
    ...
    try:
        ...
        # TODO: Atualizar status no SuiteCRM
